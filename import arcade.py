...
# Draw the engine
arcade.draw_rect_filled(arcade.XYWH(700, 120, 140, 70), arcade.color.GRAY)
arcade.draw_rect_filled(arcade.XYWH(690, 105, 90, 40), arcade.color.BLACK)

# Draw the smoke stack
arcade.draw_rect_filled(arcade.XYWH(680, 175, 10, 40), arcade.color.BLACK)

# Back wheel
arcade.draw_circle_filled(590, 110, 50, arcade.color.BLACK)
arcade.draw_circle_filled(590, 110, 45, arcade.color.BLACK_OLIVE)
arcade.draw_circle_filled(590, 110, 35, arcade.color.OLD_LACE)
arcade.draw_circle_filled(590, 110, 10, arcade.color.RED)

# Front wheel
arcade.draw_circle_filled(750, 90, 30, arcade.color.BLACK)
arcade.draw_circle_filled(750, 90, 25, arcade.color.BLACK_OLIVE)
arcade.draw_circle_filled(750, 90, 18, arcade.color.OLD_LACE)
arcade.draw_circle_filled(750, 90, 5, arcade.color.RED)
